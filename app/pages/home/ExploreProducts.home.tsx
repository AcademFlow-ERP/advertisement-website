...
export default function ExploreProductsHome(){
    ...
    return(<section className="w-full relative flex flex-col items-center justify-center p-5 xl:p-15 text-[#31859c]">
        <div className="w-full flex flex-col justify-center items-center max-w-7xl max-sm:px-0 px-10 md:max-lg:px-5 py-5 xl:gap-5 gap-10">
          <h1 className="text-3xl sm:text-4xl max-w-2xl font-poppins font-bold text-center">One Software, All School Management Processes Simplified.</h1> 
          <div className="w-full relative flex flex-col xl:flex-row max-xl:justify-center items-center p-10 md:max-lg:px-2 gap-10 xl:gap-20 text-gray-700 xl:text-gray-500 max-xl:bg-[#e3ecfa] max-xl:rounded-4xl">
                ...
                <ul className="flex max-xl:justify-between md:max-xl:items-center font-medium max-md:font-semibold max-md:flex-col xl:flex-col xl:text-lg xl:font-semibold gap-5 md:gap-3">
                    {
                        ...
                        <div className="flex flex-col" key={product.id+index}>
                            ...
                            <div className={`w-full animate-slide-in-up md:hidden py-8 px-3 ${product.id == activeExploreProduct.id ? `flex flex-col`:`hidden`}`}>
                                <div className="bg-white p-5 mt-5 rounded-4xl shadow-xl">
                                ...
                                <div className="flex flex-col gap-4 py-8">
                                    ...
                                    <h1 className="text-3xl font-bold text-gray-800 xl:text-gray-600">{product.subTitle}</h1>
                                    <p>{product.content}</p>
                                    <ButtonMiscelleneous
