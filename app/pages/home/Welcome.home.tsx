        ...
        <div className="flex flex-col w-full justify-center items-center max-w-7xl px-5 py-10 gap-10">
          <div className="flex flex-col items-center gap-5">
            ...
            <div className="flex flex-col gap-3 3xs:gap-1">
              <h1 className="max-xs:text-xl text-2xl 3xl:max-sm:text-4xl sm:text-5xl max-w-4xl font-inter 3xs:font-poppins font-black 3xs:font-bold text-center">Simplify Your School Management Functions in One intuitive Platform.</h1> 
