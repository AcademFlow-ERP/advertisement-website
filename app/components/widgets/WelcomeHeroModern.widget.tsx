    ...
    return(
      <>
            <section className="w-full relative flex flex-col items-center justify-center gradient-bg-header py-20 text-[#31859c] gap-10">
              <div className="w-full flex flex-col max-lg:flex-col-reverse lg:flex-row justify-center items-center px-10 xl:px-20 py-20 gap-10">
                <div className="w-full flex flex-col max-lg:items-center gap-8">
                  <div className="flex flex-col gap-3 max-lg:items-center">
                    ...
                    <h1 className="max-sm:text-4xl text-[2.8rem] leading-tight font-poppins font-bold capitalize max-lg:text-center">{title}</h1> 
                    <p className="font-medium text-lg max-w-xl py-2 max-lg:text-center">{description}</p>
                  </div>
                  <ButtonMiscelleneous
                ...
                <div className="w-full lg:max-xl:min-w-xl xl:min-w-2xl from-white via-white bg-gradient-to-r to-[#ffffffaf] p-5 lg:p-10 shadow z-[1] backdrop-blur">
                  <img className="shadow object-contain object-center" loading="lazy" src={displayImageUrl} alt={title} title={title}/>
                </div>
                <div className="absolute max-lg:left-4 size-14 max-lg:top-26 lg:right-12 lg:size-20 lg:bottom-40 rounded-2xl bg-conic-180 from-[#31859c] via-indigo-50 to-[#31859c]"></div>
              </div>
            </section>
